...
export default function About() {
  return (
    <>
    <div style={{fontSize:'20px',padding:'35px'}}>
    ...
    <div style={{fontSize:'20px',padding:'0px 35px'}}>
